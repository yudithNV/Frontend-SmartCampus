<template>
  <aside class="sidebar" :class="{ collapsed }">
    ...
    <nav class="sidebar-menu">
      ...
      <router-link to="/estudiante/calendario" class="menu-item"
        ...
        <transition name="text-fade">
          <span v-if="!collapsed">Calendario</span>
        </transition>
      </router-link>
      ...
      <router-link to="/estudiante/favoritos" class="menu-item"
        :class="{ active: $route.path.includes('favoritos') }">
        ...
        <transition name="text-fade">
          <span v-if="!collapsed">Mis Favoritos</span>
        </transition>
      </router-link>
