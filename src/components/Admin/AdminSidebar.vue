<template>
  <aside class="sidebar" :class="{ collapsed }">
    ...
    <nav class="sidebar-menu">
      ...
      <router-link to="/admin/sugerencias" class="menu-item" :class="{ active: $route.path.includes('sugerencias') }">
        <span class="icon">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <router-link to="/admin/reportes" class="menu-item" :class="{ active: $route.path.includes('reportes') }">
        <span class="icon">
          <!-- Reports -->
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
